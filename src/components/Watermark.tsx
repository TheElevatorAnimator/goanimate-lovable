...
const Watermark: React.FC<WatermarkProps> = ({ 
  ...
  return (
    <>
      {/* Ugly Watermark - Only shows for free users */}
      ...
      {/* Outro Banner - Only shows for free users */}
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-2">
            <div className="flex items-center">
              ...
              <p className="text-sm">
                <span className="font-bold">REMOVE WATERMARK & OUTRO</span> - PlotPlus costs only {pricingInfo.usd} USD / {pricingInfo.gbp} GBP
              </p>
            </div>
            <div className="flex items-center gap-2">
              <CustomButton
                ...
                theme="comedyWorld"
                size="sm"
                onClick={() => alert('Please subscribe to PlotPlus to remove the watermark and outro!')}
